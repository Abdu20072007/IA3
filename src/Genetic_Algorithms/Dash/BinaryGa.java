...
package Genetic_Algorithms.Dash;
...
class BinaryGA {
    ...
    // example: population[3] could be {1,1,0,1,0,0,1,0,1,1} which means Dashs at
    // indices 0,1,3,6,8,9 belong to group 1
     ...
     *
     * @return value the number of consecutive colinear and adjacent LineSegments
     *         (dashes)
     */
